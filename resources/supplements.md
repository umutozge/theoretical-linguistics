...
Please first check the errata below.
...
Tallerman, M. (2015). *Understanding Syntax*. 4th Edition. Hodder Education, Croydon, UK. (theory-neutral)  
Olaf Koeneman and Hedde Zeijlstra (2017). *Introducing Syntax*. Cambridge University Press: Cambridge, UK. (generative) 
